...
<section class="bg-white dark:bg-dark-300  max-md:py-20 pt-150 pb-150 relative">
  <div
    class="absolute left-0 right-0 top-1/2 -translate-y-1/2 bg-[url('../images/service-bg.png')] bg-no-repeat bg-center opacity-70 w-full h-full  md:hidden"
  ></div>
  <div class="container relative">
    ...
    <div class="relative z-10">
      <div
        class="absolute left-1/2 top-[37%] -translate-x-1/2 -translate-y-1/2 flex max-lg:flex-col max-lg:item-center -z-10 max-md:hidden"
      >
        <div
      ...
      <div class=" flex flex-wrap max-md:flex-col gap-6 gap-y-8 justify-center mb-12">
        ...
        >
          <div class="border border-dashed rounded border-gray-100 dark:border-borderColour-dark p-7 ">
            <img
              src="assets/images/testimonial/bodygroup.svg"
              alt="image"
              class="inline-block dark:hidden mb-6"
            />
            <img
              src="assets/images/testimonial/bodygroup-dark.svg"
              alt="image"
            ...
            <div class="pt-7 flex items-center border-t border-dashed border-gray-100 dark:border-borderColour-dark">
              <img
                src="assets/images/testimonial/avatar1.png"
                alt="avatar"
                class="mr-4 rounded-full"
              />
              <div class="block">
                <h3 class="text-base font-semibold">Robert Frost</h3>
                <p class="text-paragraph-light dark:text-[#A1A49D] font-jakarta text-sm font-medium">Lead Designer</p>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <div class="border border-dashed rounded border-gray-100 dark:border-borderColour-dark p-7 ">
            <img
              src="assets/images/testimonial/caudile.svg"
              alt="image"
              class="inline-block dark:hidden mb-6"
            />
            <img
              src="assets/images/testimonial/caudile-dark.svg"
              alt="image"
              class="hidden dark:inline-block mb-6"
            />
            <blockquote class="text-paragraph dark:text-white italic mb-5 leading-[1.75]">
            ...
            <div class="pt-7 flex items-center border-t border-dashed border-gray-100 dark:border-borderColour-dark">
              <img
                src="assets/images/testimonial/avatar2.png"
                alt="avatar"
                class="mr-4 rounded-full"
              />
              <div class="block">
                <h3 class="text-base font-semibold">Guy Hawkins</h3>
                <p class="text-paragraph-light dark:text-[#A1A49D]  font-jakarta text-sm font-medium">Developer</p>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <div class="border border-dashed rounded border-gray-100 dark:border-borderColour-dark p-7 ">
            <img
              src="assets/images/testimonial/axeptio.svg"
              alt="image"
              class="inline-block dark:hidden mb-6"
            />
            <img
              src="assets/images/testimonial/axeptio-dark.svg"
              alt="image"
              class="hidden dark:inline-block mb-6"
            />
            <blockquote class="text-paragraph dark:text-white italic mb-5 leading-[1.75]">
            ...
            <div class="pt-7 flex items-center border-t border-dashed border-gray-100 dark:border-borderColour-dark">
              <img
                src="assets/images/testimonial/avatar3.png"
                alt="avatar"
                class="mr-4 rounded-full"
              />
              <div class="block">
                <h3 class="text-base font-semibold">Cody Fisher</h3>
                <p class="text-paragraph-light dark:text-[#A1A49D]  font-jakarta text-sm font-medium">UI Designer</p>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <div class="border border-dashed rounded border-gray-100 dark:border-borderColour-dark p-7 ">
            <img
              src="assets/images/testimonial/infinity.svg"
              alt="image"
              class="inline-block dark:hidden mb-6"
            />
            <img
              src="assets/images/testimonial/infinity-dark.svg"
              alt="image"
              class="hidden dark:inline-block mb-6"
            />
            <blockquote class="text-paragraph dark:text-white italic mb-5 leading-[1.75]">
            ...
            <div class="pt-7 flex items-center border-t border-dashed border-gray-100 dark:border-borderColour-dark">
              <img
                src="assets/images/testimonial/avatar4.png"
                alt="avatar"
                class="mr-4 rounded-full"
              />
              <div class="block">
                <h3 class="text-base font-semibold">Albert Flores</h3>
                <p class="text-paragraph-light dark:text-[#A1A49D]  font-jakarta text-sm font-medium">
                  Junior Designer
                </p>
              </div>
            </div>
        ...
        >
          <div class="border border-dashed rounded border-gray-100 dark:border-borderColour-dark p-7">
            <img
              src="assets/images/testimonial/mfinity.svg"
              alt="image"
              class="inline-block dark:hidden mb-6"
            />
            <img
              src="assets/images/testimonial/mfinity-dark.svg"
              alt="image"
              class="hidden dark:inline-block mb-6"
            />
            <blockquote class="text-paragraph dark:text-white italic mb-5 leading-[1.75]">
            ...
            <div class="pt-7 flex items-center border-t border-dashed border-gray-100 dark:border-borderColour-dark">
              <img
                src="assets/images/testimonial/avatar5.png"
                alt="avatar"
                class="mr-4 rounded-full"
              />
              <div class="block">
                <h3 class="text-base font-semibold">Floyed Miles</h3>
                <p class="text-paragraph-light dark:text-[#A1A49D]  font-jakarta text-sm font-medium">Designer</p>
              </div>
            </div>
          </div>
        </div>
