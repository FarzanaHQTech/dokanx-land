  ...
  <div class="container">
    <div class="grid grid-cols-12 mb-20 max-lg:gap-y-10 max-lg:text-center">
      <div class="col-span-12 lg:col-span-6">
        <img
          src="assets/images/dokanx-black.png"
          alt="logo"
          class="inline-block dark:hidden mb-10 logo-width"
        />
        <img
           src="assets/images/dokanx-white.png"
          alt="logo dark version"
          class="hidden dark:inline-block  mb-10 logo-width"
        />
    ...
    <div class="seperator">
      <img
        src="assets/images/footer-seperator.svg"
        alt="footer-seperator"
        class="dark:hidden w-full object-cover"
      />
      <img
        src="assets/images/footer-seperator-dark.svg"
        alt="footer-seperator"
    ...
    <div class="py-10 max-lg:text-center">
      <div class="flex max-lg:flex-col lg:items-center">
        <p class="max-lg:mb-10">@ <span id="date"></span> DokanX. All Rights Reserved</p>
          ...
          <div>
            <div class="flex">
              <div class="relative w-full">
                <input
                  class="block w-full focus:outline-hidden focus:ring-0 text-paragraph-light dark:text-paragraph-light  border-borderColour py-2.5 px-5  border border- rounded-medium bg-transparent  placeholder:text-paragraph dark:placeholder:text-white outline-hidden focus:border-primary dark:focus:border-primary  duration-300 transition-all"
                  id="#id-10"
...
<script src="assets/vendor/gsap/scroll-trigger.min.js"></script>
<script src="assets/vendor/gsap/motionpath.js"></script>
<script src="assets/vendor/swiper/swiper.js"></script>
<script src="assets/vendor/aos/aos.js"></script>
<script src="assets/vendor/stackItem/stackItem.js"></script>
<script src="assets/vendor/number-counter.js"></script>
