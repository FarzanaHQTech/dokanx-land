<section
  class=" bg-white dark:bg-dark-300 overflow-hidden relative pt-[160px] pb-150 lg:pb-15 max-lg:pt-20 max-lg:pb-150"
>
  <div class="container ">
    <div class="grid grid-cols-2 max-md:grid-cols-1 gap-10 1xl:gap-x-24 items-center">
      <div class="max-md:order-2">
        <div class="relative pt-150 lg:py-150 lg:px-150">
          <div class="w-[250px] lg:w-[300px] aspect-video relative mx-auto">
            ...
            /> -->
            <img
              src="assets/images//solution/solution-dark.png"
              alt="vision image"
            ...
            >
              <img
                src="assets/images/dokanX_hero/hero1.jpg"
                alt="vision image"
            ...
            >
              <!-- <img
                src="assets/images//solution/solution-shape2.png"
                alt="vision image"
                class="dark:hidden  w-full"
              />
              <img
                src="assets/images//solution/solution-shape2-dark.png"
                alt="vision image"
                class="hidden dark:inline-block w-full"
              /> -->
            </div>
            ...
            >
              <!-- <img
                src="assets/images//solution/solution-shape3.png"
                alt="vision image"
                class="dark:hidden  w-full"
              />
              <img
                src="assets/images//solution/solution-shape3-dark.png"
                alt="vision image"
                class="hidden dark:inline-block w-full"
              /> -->
            </div>
      ...
      <div class="max-md:order-1 lg:-mt-15">
        <p class="section-tagline">Strong Solutions</p>

        <h2 class="max-lg:mb-4 mb-8">Ensure strong solutions are available at all times</h2>
        ...
        <ul
          class="max-lg:mb-6 mb-14 flex max-md:flex-col max-md:gap-y-5 lg:items-center lg:[&>*:not(:last-child)]:mr-10 "
        >
          <li class="relative flex items-center gap-x-2 ">
            <i class="fa-solid fa-check text-paragraph dark:text-primary"></i>
            <span class="dark:text-white font-jakarta font-medium">On Demand Support</span>
          </li>
          <li class="relative flex items-center gap-x-2 ">
            <i class="fa-solid fa-check text-paragraph dark:text-primary"></i>
            <span class="dark:text-white font-jakarta font-medium">Information Sharing</span>
          </li>
          <li class="relative flex items-center gap-x-2 ">
            <i class="fa-solid fa-check text-paragraph dark:text-primary"></i>
            <span class="dark:text-white font-jakarta font-medium">Cloud Technology</span>
          </li>
        </ul>
        <a
