<?php
    $page_title = "Payments - DokanX";
    $page = 'payments';
    $show_breadcrumb = false;
?>

<section class="hero relative lg:pt-[260px] max-lg:pt-[160px] pb-[140px] overflow-hidden lg:overflow-visible">
  <div class="container">
    <div class="grid grid-cols-12 gap-5 items-end relative  z-10">
      <div
        class="max-md:col-span-full md:col-span-7 max-md:mb-[350px]"
        data-aos="fade-up"
        data-aos-offset="200"
      ...
      <div
        class="max-md:col-span-full md:col-span-5 relative md:z-10"
        data-aos="fade-up"
        data-aos-offset="200"
        data-aos-duration="1000"
        data-aos-once="true"
      >
        ...
        <div
          class="absolute left-1/2 -bottom-150 p-[350px] -translate-x-1/2 bg-contain w-full h-full  bg-[url('../images/hero-gradient.png')] bg-no-repeat bg-center opacity-70 md:hidden -z-10"
        ></div>
        <div class="w-full h-full">
          <div class="relative  ">
            <img
              src="assets/images/payment/payment-hero.png"
              alt="hero Image"
              class="inline-block dark:hidden w-full rounded-medium shadow-nav"
            />
            <img
              src="assets/images/payment/payment-hero-dark.png"
              alt="hero Image"
            ...
            >
              <img
                src="assets/images/payment/payment-hero-device.png"
                alt="hero Image"
                class="inline-block dark:hidden rounded-t-medium  w-full"
              />
              <img
                src="assets/images/payment/payment-hero-device-dark.png"
                alt="hero Image"
...
<section>
  <div class="container">
    <div class="grid grid-cols-12 gap-5 bg-white dark:bg-dark-200 shadow-nav p-2.5 items-center rounded-medium">
      <div
        class="max-lg:col-span-full lg:col-span-5 lg:max-w-[425px] pl-12 max-lg:text-center max-lg:pl-0 max-lg:py-12"
      >
        <h2 class=" mb-8">
          Thousands of <br />
      ...
      <div class="max-lg:col-span-full lg:col-span-7">
        <div class=" grid grid-cols-3 max-lg:grid-cols-1 gap-3">
          <div
            class=" border border-dashed border-gray-100 rounded dark:border-borderColour-dark py-12 px-7 text-center"
          >
...
<section class="relative pt-[200px] overflow-x-hidden">
  ...
  >
    <div class="grid grid-cols-2 max-md:grid-cols-1 max-md:gap-10 gap-25 1xl:gap-x-24 items-end relative">
      ...
      >
        <img
          src="assets/images/payment/whyUs-bg.png"
          alt="hero Image"
          class="inline-block dark:hidden w-full rounded-medium shadow-nav"
        />
        <img
          src="assets/images/payment/whyUs-bg-dark.png"
          alt="hero Image"
          class="hidden dark:inline-block w-full rounded-medium shadow-nav"
        />
        <div class="absolute left-1/2 -translate-x-1/2 max-lg:w-8/12 mx-auto bottom-2.5 w-[400px] aspect-video">
          <img
            src="assets/images/payment/whyUs-image.png"
            alt="hero Image"
            class="inline-block dark:hidden  rounded-t-medium  "
          />
          <img
            src="assets/images/payment/whyUs-image-dark.png"
            alt="hero Image"
      ...
      <div class="relative max-md:order-2">
        ...
        <ul class="mb-14 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4">
          <li class="flex items-center gap-x-2 ">
            <span
              class=" relative  rounded-full bg-white dark:bg-dark-200 drop-shadow flex item-center justify-center gap-6"
            >
              <svg
          ...
          <li class="flex items-center gap-x-2">
            <span class=" relative  rounded-full bg-white dark:bg-dark-200 drop-shadow flex item-center justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="28"
                height="30"
    ...
    <div class="grid grid-cols-2 max-md:grid-cols-1 gap-25 1xl:gap-x-24 items-end ">
      <div class="relative max-md:order-1 md:order-2">
        ...
        <ul class="mb-14 [&>*:not(:last-child)]:mb-5 max-w-[490px]">
          ...
          >
            <span class=" relative w-10 h-10 rounded-full bg-[#F3F8E8] dark:bg-dark-200 drop-shadow  gap-6">
              <i class="fa-solid fa-check absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-primary"></i>
            </span>
            <span class="font-semibold font-jakarta"> It’s scalable and secure </span>
          </li>
          <li
          ...
          >
            ...
            <span class="font-semibold font-jakarta"> Cash Flow Statements </span>
          </li>
        </ul>
        <a
          href="contact.html"
      ...
      <div class="relative max-md:order-2 md:order-1">
        <div
          class="max-lg:w-full lg:w-[420px] lg:h-[500px]"
          data-aos="fade-left"
          data-aos-offset="200"
          data-aos-duration="1000"
          data-aos-once="true"
        >
          <img
            src="assets/images/payment/explore.png"
            alt="explore"
            class="rounded-medium dark:hidden"
          />
          <img
            src="assets/images/payment/explore-dark.png"
            alt="explore"
        ...
        >
          <img
            src="assets/images/payment/summery.png"
            alt="summery"
            class=" dark:hidden w-full"
          />
          <img
            src="assets/images/payment/summery-dark.png"
            alt="summery"
        ...
        >
          ...
          />
          <img
            src="assets/images/payment/payment-dark.png"
            alt="summery"
            class="hidden dark:inline-block w-full"
          />
        </div>
        ...
        >
          <img
            src="assets/images/payment/expense.png"
            alt="summery"
            class="dark:hidden w-full"
          />
          <img
            src="assets/images/payment/expense-dark.png"
            alt="summery"
