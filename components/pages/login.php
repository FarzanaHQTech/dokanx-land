...
<?php
    $page_title = "Login - DokanX";
    $page = 'login';
    $show_breadcrumb = false;

?>
<section class="pt-[200px] mb-150 max-md:mb-25 relative ">
  <div
    ...
    <div class="relative z-10 max-w-[510px] mx-auto">
      ...
      <div class="bg-white dark:bg-dark-200 rounded-medium p-2.5 shadow-nav">
        ...
        >
          <div>
            <button
              class=" py-3.5 max-md:px-5 px-[30px] -tracking-[0.3px] rounded-[30px] font-jakarta font-medium  text-sm bg-white text-paragraph border-borderColour  dark:bg-transparent border dark:border-borderColour-dark dark:text-white w-full flex items-center justify-center gap-2 group mb-6"
            >
              <svg
              ...
              <span class="font-jakarta font-medium  "> Continue with Google </span>
            </button>
            <button
              class=" py-3.5 max-md:px-5 px-[30px] -tracking-[0.3px] rounded-[30px] font-jakarta font-medium  text-sm bg-white text-paragraph border-borderColour  dark:bg-transparent border dark:border-borderColour-dark dark:text-white w-full flex items-center justify-center gap-2 group"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
              ...
              <span class="font-jakarta font-medium text-sm "> Continue with Facebook </span>
            </button>
          </div>
          <div
          ...
          <form>
            <div class="grid grid-cols-12 gap-y-6 ">
              <div class="col-span-12">
                <label
                  for="email"
                  class="block text-sm font-medium font-jakarta text-paragraph dark:text-white mb-2"
                >
                  Email
                </label>
                <input
                  ...
                  class="block w-full text-sm rounded-[48px] border border-borderColour dark:border-borderColour-dark py-3.5 px-5 text-paragraph-light placeholder:text-paragraph-light dark:placeholder:text-paragraph-light outline-hidden bg-white dark:bg-dark-200 focus:border-primary dark:focus:border-primary duration-300 transition-all"
                />
              </div>
              <div class="col-span-full">
                ...
                <input
                  ...
                  class="block w-full text-sm rounded-[48px] border border-borderColour dark:border-borderColour-dark py-3.5 px-5 text-paragraph-light   placeholder:text-paragraph-light outline-hidden bg-white dark:bg-dark-200 focus:border-primary dark:focus:border-primary duration-300 transition-all"
                />
              </div>
              <div class="col-span-full flex items-center justify-between">
                ...
                >
                  ...
                  />
                  <div
                    class=" w-5 h-5 rounded-full border border-borderColour dark:border-borderColour-dark relative after:absolute after:w-2.5 after:h-2.5 after:bg-primary after:rounded-full after:top-1/2 after:left-1/2 after:-translate-x-1/2 after:-translate-y-1/2 after:opacity-0 peer-checked:after:opacity-100 peer-checked:border-primary dark:peer-checked:border-primary cursor-pointer"
                  ></div>

                  <span class="block text-sm font-medium text-paragraph dark:text-white font-jakarta">
                    Remember me
                  </span>
                </label>
                <a
                  href="forgetpassword.html"
                  class="relative font-jakarta inline-block overflow-hidden text-sm font-medium text-paragraph dark:text-white before:absolute before:bottom-0 before:left-0 before:h-[1px] before:w-full before:origin-right before:scale-x-0 before:bg-paragraph dark:before:bg-white  before:transition-transform before:duration-500 before:content-[''] hover:before:origin-left hover:before:scale-x-100 leading-[24px] align-bottom"
                >
                  Forget Password
                </a>
              </div>
              <div class="col-span-full ">
                <button class="btn w-full block font-medium">Login</button>
              </div>
              <div class="col-span-full ">
                <p class="text-sm font-medium text-center font-jakarta leading-[24px]">
                  Not registered yet?
                  <a
                    href="signup.html"
                    class="relative font-jakarta inline-block overflow-hidden text-sm  font-medium text-paragraph dark:text-white before:absolute before:bottom-0 before:left-0 before:h-[1px] before:w-full before:origin-right before:scale-x-0 before:bg-paragraph dark:before:bg-white  before:transition-transform before:duration-500 before:content-[''] hover:before:origin-left hover:before:scale-x-100 leading-[24px] align-bottom"
